pipeline {
    ...
    environment{
        ...
        nexusUrl = 'nexus.avyan.site:8081'
        region = "us-east-1"
        account_id = "637423596117"
    }
    stages {
        ...
        stage('Deploy'){
            steps{
                ...
                """
                //give helm install frontend . when running for the 1st time
                //give helm upgrade frontend . when running after 1st time
            }
        }
